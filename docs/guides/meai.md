...
The Strava SDK provides integration with [Microsoft.Extensions.AI](https://learn.microsoft.com/en-us/dotnet/ai/microsoft-extensions-ai), enabling seamless interoperability with the unified .NET AI abstractions.

## Installation

```bash
dotnet add package Strava
```
...
using var client = new StravaClient(
    apiKey: Environment.GetEnvironmentVariable("STRAVA_API_KEY")!);
