...
namespace Strava
{
    public partial interface IActivitiesClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Strava.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Strava.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::Strava.SummaryActivity>>> GetLoggedInAthleteActivitiesAsResponseAsync(
            int? before = default,
            int? after = default,
            int? page = default,
            int? perPage = default,
