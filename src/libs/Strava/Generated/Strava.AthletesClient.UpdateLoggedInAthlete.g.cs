...
namespace Strava
{
    public partial class AthletesClient
    {
        ...
        partial void PrepareUpdateLoggedInAthleteArguments(
            ...
            ref float weight);
        partial void PrepareUpdateLoggedInAthleteRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            float weight);
        partial void ProcessUpdateLoggedInAthleteResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateLoggedInAthleteResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Strava.DetailedAthlete> UpdateLoggedInAthleteAsync(
            float weight,
            global::Strava.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await UpdateLoggedInAthleteAsResponseAsync(
                weight: weight,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Strava.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Strava.AutoSDKHttpResponse<global::Strava.DetailedAthlete>> UpdateLoggedInAthleteAsResponseAsync(
            float weight,
            global::Strava.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateLoggedInAthleteArguments(
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Strava.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Strava.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UpdateLoggedInAthleteAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateLoggedInAthleteResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Strava.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateLoggedInAthleteResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
