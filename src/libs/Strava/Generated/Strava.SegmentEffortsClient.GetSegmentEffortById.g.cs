...
namespace Strava
{
    public partial class SegmentEffortsClient
    {
        ...
        private static readonly global::Strava.EndPointSecurityRequirement s_GetSegmentEffortByIdSecurityRequirement0 =
        ...
        private static readonly global::Strava.EndPointSecurityRequirement[] s_GetSegmentEffortByIdSecurityRequirements =
            new global::Strava.EndPointSecurityRequirement[]
            {                s_GetSegmentEffortByIdSecurityRequirement0,
            };
        partial void PrepareGetSegmentEffortByIdArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref long id);
        partial void PrepareGetSegmentEffortByIdRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            long id);
        partial void ProcessGetSegmentEffortByIdResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetSegmentEffortByIdResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Strava.DetailedSegmentEffort> GetSegmentEffortByIdAsync(
            long id,
            global::Strava.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetSegmentEffortByIdAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Strava.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Strava.AutoSDKHttpResponse<global::Strava.DetailedSegmentEffort>> GetSegmentEffortByIdAsResponseAsync(
            long id,
            global::Strava.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetSegmentEffortByIdArguments(
            ...
            var __authorizations = global::Strava.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetSegmentEffortByIdSecurityRequirements,
                operationName: "GetSegmentEffortByIdAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetSegmentEffortByIdRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Strava.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Strava.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetSegmentEffortByIdAsync",
                                pathTemplate: "$\"/segment_efforts/{id}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetSegmentEffortByIdResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Strava.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetSegmentEffortByIdResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Strava.DetailedSegmentEffort.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Strava.AutoSDKHttpResponse<global::Strava.DetailedSegmentEffort>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Strava.DetailedSegmentEffort.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
