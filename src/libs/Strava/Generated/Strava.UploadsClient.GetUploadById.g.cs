...
namespace Strava
{
    public partial class UploadsClient
    {
        ...
        private static readonly global::Strava.EndPointSecurityRequirement s_GetUploadByIdSecurityRequirement0 =
        ...
        private static readonly global::Strava.EndPointSecurityRequirement[] s_GetUploadByIdSecurityRequirements =
            new global::Strava.EndPointSecurityRequirement[]
            {                s_GetUploadByIdSecurityRequirement0,
            };
        partial void PrepareGetUploadByIdArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref long uploadId);
        partial void PrepareGetUploadByIdRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            long uploadId);
        partial void ProcessGetUploadByIdResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetUploadByIdResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Strava.Upload> GetUploadByIdAsync(
            long uploadId,
            global::Strava.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetUploadByIdAsResponseAsync(
                uploadId: uploadId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Strava.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Strava.AutoSDKHttpResponse<global::Strava.Upload>> GetUploadByIdAsResponseAsync(
            long uploadId,
            global::Strava.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Strava.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetUploadByIdSecurityRequirements,
                operationName: "GetUploadByIdAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Strava.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Strava.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetUploadByIdAsync",
                                pathTemplate: "$\"/uploads/{uploadId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Strava.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetUploadByIdResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Strava.Upload.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Strava.AutoSDKHttpResponse<global::Strava.Upload>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Strava.Upload.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
