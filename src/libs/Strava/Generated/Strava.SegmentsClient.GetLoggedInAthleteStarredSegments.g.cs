...
namespace Strava
{
    public partial class SegmentsClient
    {
        ...
        {
            var __response = await GetLoggedInAthleteStarredSegmentsAsResponseAsync(
                page: page,
                perPage: perPage,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Strava.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Strava.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::Strava.SummarySegment>>> GetLoggedInAthleteStarredSegmentsAsResponseAsync(
            int? page = default,
            int? perPage = default,
            global::Strava.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Strava.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Strava.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetLoggedInAthleteStarredSegmentsAsync",
                                pathTemplate: "\"/segments/starred\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::Strava.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = (global::System.Collections.Generic.IList<global::Strava.SummarySegment>?)global::System.Text.Json.JsonSerializer.Deserialize(__content, typeof(global::System.Collections.Generic.IList<global::Strava.SummarySegment>), JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Strava.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::Strava.SummarySegment>>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = (global::System.Collections.Generic.IList<global::Strava.SummarySegment>?)await global::System.Text.Json.JsonSerializer.DeserializeAsync(__content, typeof(global::System.Collections.Generic.IList<global::Strava.SummarySegment>), JsonSerializerContext).ConfigureAwait(false) ??
