...
namespace Strava
{
    public partial class AthletesClient
    {
        ...
        private static readonly global::Strava.EndPointSecurityRequirement s_GetLoggedInAthleteSecurityRequirement0 =
        ...
        private static readonly global::Strava.EndPointSecurityRequirement[] s_GetLoggedInAthleteSecurityRequirements =
            new global::Strava.EndPointSecurityRequirement[]
            {                s_GetLoggedInAthleteSecurityRequirement0,
            };
        partial void PrepareGetLoggedInAthleteArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareGetLoggedInAthleteRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessGetLoggedInAthleteResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetLoggedInAthleteResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Strava.DetailedAthlete> GetLoggedInAthleteAsync(
            global::Strava.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetLoggedInAthleteAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Strava.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Strava.AutoSDKHttpResponse<global::Strava.DetailedAthlete>> GetLoggedInAthleteAsResponseAsync(
            global::Strava.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetLoggedInAthleteArguments(
                httpClient: HttpClient);


            var __authorizations = global::Strava.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_GetLoggedInAthleteSecurityRequirements,
                operationName: "GetLoggedInAthleteAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetLoggedInAthleteRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Strava.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Strava.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetLoggedInAthleteAsync",
                                pathTemplate: "\"/athlete\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetLoggedInAthleteResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Strava.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetLoggedInAthleteResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Strava.DetailedAthlete.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Strava.AutoSDKHttpResponse<global::Strava.DetailedAthlete>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Strava.DetailedAthlete.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
