...
namespace Strava
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Strava.AutoSDKRetryOptions Retry { get; set; } = new global::Strava.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Strava.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Strava.IAutoSDKHook>();
        ...
        public global::Strava.AutoSDKClientOptions AddHook(
            global::Strava.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Strava.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Strava.AutoSDKClientOptions UseAuthorizationProvider(
            global::Strava.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Strava.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Strava.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Strava.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Strava.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Strava.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Strava.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Strava.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Strava.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Strava.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Strava.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Strava.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Strava.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Strava.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Strava.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Strava.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Strava.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Strava.AutoSDKClientOptions clientOptions,
            global::Strava.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Strava.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Strava.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Strava.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Strava.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Strava.IAutoSDKHook, global::Strava.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Strava.AutoSDKHookContext context)
        {
