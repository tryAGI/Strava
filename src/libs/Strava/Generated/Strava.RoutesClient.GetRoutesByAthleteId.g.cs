...
namespace Strava
{
    public partial class RoutesClient
    {
        ...
        private static readonly global::Strava.EndPointSecurityRequirement s_GetRoutesByAthleteIdSecurityRequirement0 =
        ...
        private static readonly global::Strava.EndPointSecurityRequirement[] s_GetRoutesByAthleteIdSecurityRequirements =
            new global::Strava.EndPointSecurityRequirement[]
            {                s_GetRoutesByAthleteIdSecurityRequirement0,
            };
        partial void PrepareGetRoutesByAthleteIdArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int? page,
            ref int? perPage,
            ref string id);
        partial void PrepareGetRoutesByAthleteIdRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int? page,
            int? perPage,
            string id);
        partial void ProcessGetRoutesByAthleteIdResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetRoutesByAthleteIdResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::System.Collections.Generic.IList<global::Strava.Route>> GetRoutesByAthleteIdAsync(
            string id,
            int? page = default,
            int? perPage = default,
        ...
        {
            var __response = await GetRoutesByAthleteIdAsResponseAsync(
                id: id,
                page: page,
                perPage: perPage,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Strava.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Strava.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::Strava.Route>>> GetRoutesByAthleteIdAsResponseAsync(
            string id,
            int? page = default,
            int? perPage = default,
            global::Strava.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetRoutesByAthleteIdArguments(
            ...
            var __authorizations = global::Strava.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetRoutesByAthleteIdSecurityRequirements,
                operationName: "GetRoutesByAthleteIdAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetRoutesByAthleteIdRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Strava.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Strava.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetRoutesByAthleteIdAsync",
                                pathTemplate: "$\"/athletes/{id}/routes\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetRoutesByAthleteIdResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Strava.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetRoutesByAthleteIdResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = (global::System.Collections.Generic.IList<global::Strava.Route>?)global::System.Text.Json.JsonSerializer.Deserialize(__content, typeof(global::System.Collections.Generic.IList<global::Strava.Route>), JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Strava.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::Strava.Route>>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = (global::System.Collections.Generic.IList<global::Strava.Route>?)await global::System.Text.Json.JsonSerializer.DeserializeAsync(__content, typeof(global::System.Collections.Generic.IList<global::Strava.Route>), JsonSerializerContext).ConfigureAwait(false) ??
