...
{
    /// <inheritdoc />
    public class TimedZoneRangeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Strava.TimedZoneRange>
    {
        /// <inheritdoc />
        public override global::Strava.TimedZoneRange Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score1 = 0;
            if (__jsonProps.Contains("time")) __score1++;
            var __bestScore = 0;
            var __bestIndex = -1;
            if (__score0 > __bestScore) { __bestScore = __score0; __bestIndex = 0; }
            if (__score1 > __bestScore) { __bestScore = __score1; __bestIndex = 1; }

            global::Strava.ZoneRange? zoneRange = default;
            global::Strava.TimedZoneRangeVariant2? timedZoneRangeVariant2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
            ...
            var __value = new global::Strava.TimedZoneRange(
                zoneRange,
        ...
        public override void Write(
            ...
            global::Strava.TimedZoneRange value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");

            if (value.IsZoneRange)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Strava.ZoneRange), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Strava.ZoneRange?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::Strava.ZoneRange).Name}");
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.ZoneRange!, typeInfo);
            }
            else if (value.IsTimedZoneRangeVariant2)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Strava.TimedZoneRangeVariant2), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Strava.TimedZoneRangeVariant2?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::Strava.TimedZoneRangeVariant2).Name}");
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.TimedZoneRangeVariant2!, typeInfo);
            }
        }
    }
}