...
{
    /// <inheritdoc />
    public class DetailedGearJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Strava.DetailedGear>
    {
        /// <inheritdoc />
        public override global::Strava.DetailedGear Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__jsonProps.Contains("primary")) __score0++;
            if (__jsonProps.Contains("resource_state")) __score0++;
            var __score1 = 0;
            if (__jsonProps.Contains("brand_name")) __score1++;
            if (__jsonProps.Contains("description")) __score1++;
            if (__jsonProps.Contains("frame_type")) __score1++;
            ...
            global::Strava.SummaryGear? summary = default;
            global::Strava.DetailedGearVariant2? detailedGearVariant2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
            ...
            var __value = new global::Strava.DetailedGear(
                summary,
        ...
        public override void Write(
            ...
            global::Strava.DetailedGear value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
            ...
            else if (value.IsDetailedGearVariant2)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Strava.DetailedGearVariant2), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Strava.DetailedGearVariant2?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::Strava.DetailedGearVariant2).Name}");
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.DetailedGearVariant2!, typeInfo);
            }
        }
    }
}