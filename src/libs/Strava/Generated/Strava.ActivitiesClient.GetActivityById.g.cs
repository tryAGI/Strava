...
namespace Strava
{
    public partial class ActivitiesClient
    {
        ...
        private static readonly global::Strava.EndPointSecurityRequirement s_GetActivityByIdSecurityRequirement0 =
        ...
        private static readonly global::Strava.EndPointSecurityRequirement[] s_GetActivityByIdSecurityRequirements =
            new global::Strava.EndPointSecurityRequirement[]
            {                s_GetActivityByIdSecurityRequirement0,
            };
        partial void PrepareGetActivityByIdArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref long id,
            ref bool? includeAllEfforts);
        partial void PrepareGetActivityByIdRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            long id,
            bool? includeAllEfforts);
        partial void ProcessGetActivityByIdResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetActivityByIdResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Strava.DetailedActivity> GetActivityByIdAsync(
            long id,
            bool? includeAllEfforts = default,
            global::Strava.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetActivityByIdAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Strava.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Strava.AutoSDKHttpResponse<global::Strava.DetailedActivity>> GetActivityByIdAsResponseAsync(
            long id,
            bool? includeAllEfforts = default,
            global::Strava.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetActivityByIdArguments(
                httpClient: HttpClient,
                id: ref id,
                includeAllEfforts: ref includeAllEfforts);


            var __authorizations = global::Strava.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_GetActivityByIdSecurityRequirements,
                operationName: "GetActivityByIdAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                .AddOptionalParameter("include_all_efforts", includeAllEfforts?.ToString().ToLowerInvariant())
                                ;
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Strava.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Strava.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetActivityByIdAsync",
                                pathTemplate: "$\"/activities/{id}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetActivityByIdResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Strava.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetActivityByIdResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Strava.DetailedActivity.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Strava.AutoSDKHttpResponse<global::Strava.DetailedActivity>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Strava.DetailedActivity.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
