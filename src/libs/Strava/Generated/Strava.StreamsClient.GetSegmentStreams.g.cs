...
namespace Strava
{
    public partial class StreamsClient
    {
        ...
        {
            var __response = await GetSegmentStreamsAsResponseAsync(
                id: id,
                keys: keys,
                keyByType: keyByType,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Strava.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Strava.AutoSDKHttpResponse<global::Strava.StreamSet>> GetSegmentStreamsAsResponseAsync(
            long id,
            global::System.Collections.Generic.IList<global::Strava.GetSegmentStreamsKey> keys,
            bool keyByType,
            global::Strava.AutoSDKRequestOptions? requestOptions = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Strava.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Strava.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetSegmentStreamsAsync",
                                pathTemplate: "$\"/segments/{id}/streams\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
